...
public class Eksempel2 {
    ...
    // Meningsløs metode som kun er ment for å øve på funksjoner og metodereferanser
    private static String personTilString(Person person, Function<Person, String> omformer) {
        return omformer.apply(person);
    }
    ...
    public static void main(String[] args) {
        ...
        People.people.sort((p1,p2) -> p1.compareTo(p2));

        People.people.forEach(p -> System.out.println(p));
